...
//                	             	<a href='edit.php?id=({$row['id']})'>修改</a>
                              	 echo "<a class='btn btn-primary btn-sm ' href='main1edit.php?id={$row['id']}&page={$page->page}'>编辑</a>";
         	                     echo "<a class='btn btn-danger btn-sm' href='../bookdelete.php?id={$row['id']}&page={$page->page}'>删除</a></td>";
                  	             echo "</tr> ";
       }
       						echo "</tbody>  </table>";
